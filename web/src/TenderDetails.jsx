...
export function TenderDetails({ tender, onTenderRefresh, onWorkflowUpdate }) {
  ...
  const analysisState = {
    ...
    onAnalysisWorkflow: saveTzWorkflow,
  }
  const economicsState = {
    ...
    onPriceBookFeedStage: stagePriceBookFeed,
    onPriceBookFeedFileStage: stagePriceBookFeedFile,
    ...
    onSupplierManualPriceStage: stageSupplierManualPriceCandidate,
