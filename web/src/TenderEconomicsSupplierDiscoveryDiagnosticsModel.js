export function supplierDiscoveryRunBuckets(diagnostics) {
  const buckets = {
    total: 0,
    checked: 0,
    blocked: 0,
...
export function formatDiscoveryRunState(diagnostics = {}) {
...
export function compactIntentRejectionReasons(reasons) {
...
export function formatIntentRejectionReason(reason) {
  const labels = {
...
export function compactDiscoveryErrors(errors) {
  const seen = new Set()
  return errors
