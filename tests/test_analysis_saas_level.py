...
def test_frontend_exposes_tz_saas_workflow_questions_and_playbooks():
    ...
    assert "from './TenderAnalysisWorkflowPanel'" in secondary_source
    assert "function AnalysisWorkflowPanel" not in secondary_source
    assert "function workflowStatusLabel" not in secondary_source
    assert "export function AnalysisWorkflowPanel" in workflow_panel_source
