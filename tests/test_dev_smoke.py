    ...
    def fetcher(url: str, timeout: float):
        if url == "http://127.0.0.1:8000/api/health":
            return 200, (
                ...
                '["supplier_search_prepare", "supplier_catalog_presets", "supplier_catalog_health", "supplier_discovery_url", "web_auto_search", "market_state_import", "dashboard_queues", "price_candidate_auto_stage"]}'
            )
