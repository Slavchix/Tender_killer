...
2. Add auto-stage run orchestration: find prices for all positions, persist run diagnostics, and feed only `auto_eligible` candidates into the existing bulk confirm review action.
