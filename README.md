...
Latest verified result before this handoff: `195 passed`.

Good next steps:

1. Let the user verify the new workbench layout, supplier candidates, and economics inputs in the local UI.
