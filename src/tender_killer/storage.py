...
def _deserialize_price_candidate(row: sqlite3.Row) -> dict[str, Any]:
    ...
    return {
        ...
        "price_breaks": raw_payload.get("price_breaks") if isinstance(raw_payload.get("price_breaks"), list) else [],
        "selected_price_break": raw_payload.get("selected_price_break") if isinstance(raw_payload.get("selected_price_break"), dict) else None,
        "price_break_selection_quantity": raw_payload.get("price_break_selection_quantity"),
