...
PROVIDER_POLICIES: dict[str, dict[str, Any]] = {
    "lemanapro": {
        "provider": "lemanapro",
        "label": "Lemana Pro",
        "default_mode": "quick_links_manual_url",
        "allow_quick_links": True,
        "allow_public_search_fetch": False,
        "allow_product_page_fetch": True,
        "allow_browser_fetch": False,
        "allow_internal_api": False,
        "recommended_flow": "quick_links_manual_url",
        "risk_level": "review_only",
        "operator_note": "Use quick links and a manually selected public product URL; do not fetch search pages automatically.",
    },
    "officemag": {
        "provider": "officemag",
        "label": "OfficeMag",
        ...
        "recommended_flow": "quick_links_manual_url",
        "risk_level": "review_only",
        "operator_note": "Use quick links and a manually selected public product URL; search-page background fetch is disabled.",
    },
    "komus": {
        "provider": "komus",
        "label": "Komus",
        "default_mode": "quick_links_feed_quote",
        "allow_quick_links": True,
        "allow_public_search_fetch": False,
        "allow_product_page_fetch": False,
        "allow_browser_fetch": False,
        "allow_internal_api": False,
        "recommended_flow": "quick_links_feed_quote",
        "risk_level": "manual_required",
        "operator_note": "Use quick links, supplier feed, quote upload, or commercial quote; do not fetch pages automatically.",
    },
    "vseinstrumenti": {
